        ...
        <div className="flrx flrx-wrap ">
            <div className="w-full lg:w-1/2">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    <h1 className="pb-16 text-6xl font-thin tracking-tight bg-gradient-to-r from-pink-400 
                    via-slate-600 to-indigo-500 bg-clip-text text-transparent lg:mt-16 lg:text-7xl">Gaurav Kathe</h1>
