...
export const HERO_CONTENT = "I am passionate about engineering software solutions, having proficiency in many domains, including full-stack web development in Android applications. My skills include a full range of languages such as C/C++, Java, Python, SQL, and NoSQL, both for the front and back ends, and creating seamless applications. My experience also includes cloud platforms like AWS, as well as frameworks such as React, Node.js, and Spring Boot. Constantly looking for new challenges, I am eager to apply this knowledge in projects that are meaningful and advance the frontier of innovation.";
